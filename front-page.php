		...
		<div class="container">
			<div class="row">
				...
				<div class="col-xs-12 col-lg-6">
					...
					<p>Fabricamos colchones bajo cualquier especificación de composición, confort o medida.</p>
					<h4>Otros productos y especialidades</h4>
					<ul>
						<li>Camas Extras.</li>
						<li>Colchones para áreas exteriores.</li>
						<li>Colchones para sofá o camarotes.</li>
						<li>Colchones a prueba de fuego.</li>
						<li>Mantenimiento y solución a problemas con colchones descocidos, dañados o incómodos.</li>
						<li>Colchonetas para incrementar el confort de las camas.</li>
						<li>Blancos y ropa de cama.</li>
					</ul>
